...
public class Draw_5Friendlist {
	...
	public static void initMAAs() {
		...
		new MouseActionArea(540, 730, 160, 60, MouseActionAreaType.FRIENDLIST_Back, "Back", 22, Color.DARK_GRAY, Color.BLACK, true, false) {
			@Override
	...
	public static void draw(Graphics g) {
		...
		GraphicsHandler.drawCentralisedText(g, Color.BLACK, FontHandler.getFont(FontHandler.medievalSharp_regular, 28), "You have X friends online", (GraphicsHandler.getWidth()*32)/100, (GraphicsHandler.getHeight()*37)/100);
